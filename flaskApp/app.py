...
# Import Chart.js from CDN in your HTML
...
# Your functions for fetching data and ML prediction
# (Assuming these functions are already defined as per your initial code)

# Your Flask routes
@app.route('/')
def index():
    return render_template('index.html', chart_js_cdn=chart_js_cdn)
